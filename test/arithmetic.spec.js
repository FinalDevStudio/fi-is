describe('arithmetic checks', function () {
  ...
  describe('no "isFinite"', function () {
    before(() => {
      if (typeof global === 'object') {
        delete global.isFinite;
      } else {
        delete window.isFinite;
      }
    });

    describe('is.finite', function () {
      it('should return true if given number is finite not using isFinite', function () {
        expect(is.finite(4)).to.be.true;
      });

      it('should return false if given number is not finite not using isFinite', function () {
        expect(is.finite(Infinity)).to.be.false;
      });
    });

    describe('is.not.finite', function () {
      it('should return false if given number is finite not using isFinite', function () {
        expect(is.not.finite(4)).to.be.false;
      });

      it('should return true if given number is not finite not using isFinite', function () {
        expect(is.not.finite(Infinity)).to.be.true;
      });
    });

    describe('is.all.finite', function () {
      it('should return true if all given numbers are finite not using isFinite', function () {
        expect(is.all.finite(1, 2)).to.be.true;
        expect(is.all.finite([1, 2])).to.be.true;
      });

      it('should return false if any given number is not finite not using isFinite', function () {
        expect(is.all.finite(Infinity, -Infinity)).to.be.false;
        expect(is.all.finite([Infinity, -Infinity])).to.be.false;
      });
    });
    ...
    describe('is.any.finite', function () {
      it('should return true if any given number is finite not using isFinite', function () {
        expect(is.any.finite(Infinity, 1)).to.be.true;
        expect(is.any.finite([Infinity, 1])).to.be.true;
      });

      it('should return false if all given numbers are not finite not using isFinite', function () {
        expect(is.any.finite(Infinity, -Infinity)).to.be.false;
        expect(is.any.finite([Infinity, -Infinity])).to.be.false;
      });
    });
    ...
    describe('is.infinite', function () {
      it('should return true if given number is infinite not using isFinite', function () {
        expect(is.infinite(Infinity)).to.be.true;
      });

      it('should return false if given number is not infinite not using isFinite', function () {
        expect(is.infinite(1)).to.be.false;
      });
    });

    describe('is.not.infinite', function () {
      it('should return false if given number is infinite not using isFinite', function () {
        expect(is.not.infinite(Infinity)).to.be.false;
      });

      it('should return true if given number is not infinite not using isFinite', function () {
        expect(is.not.infinite(1)).to.be.true;
      });
    });

    describe('is.all.infinite', function () {
      it('should return true if all given numbers are infinite not using isFinite', function () {
        expect(is.all.infinite(Infinity, -Infinity)).to.be.true;
        expect(is.all.infinite([Infinity, -Infinity])).to.be.true;
      });

      it('should return false if any given number is not infinite not using isFinite', function () {
        expect(is.all.infinite(Infinity, 1)).to.be.false;
        expect(is.all.infinite([Infinity, 1])).to.be.false;
      });
    });
    ...
    describe('is.any.infinite', function () {
      it('should return true if any given number is infinite not using isFinite', function () {
        expect(is.any.infinite(Infinity, 1)).to.be.true;
        expect(is.any.infinite([Infinity, 1])).to.be.true;
      });

      it('should return false if all given numbers are not infinite not using isFinite', function () {
        expect(is.any.infinite(1, -2)).to.be.false;
        expect(is.any.infinite([1, -2])).to.be.false;
      });
    });
